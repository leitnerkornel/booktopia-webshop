...
//         Peti's books
        ...
        // Gabor's books
        productDataStore.add(new Product("Malevil", 49.9f, "USD", "Malevil is a 1972 science fiction novel by French writer Robert Merle. The story's events take place in rural France in the late twentieth century during the unexpected outbreak of nuclear war.", thrillerId, gaborID, robertMerleID));
